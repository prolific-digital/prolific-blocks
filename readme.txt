...
= 1.1.0 =
* Added support for ARIA controls in hamburger block
* Added support for playing Lottie animations on scroll
...
= 1.1.0 =
This update adds enhanced accessibility features and animation options.