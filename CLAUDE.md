...
### Query Posts Block
- **Advanced Query Capabilities:** Post type selection, taxonomy filters, author filtering, post status
...
- **AJAX Features:** Search with debouncing, category/tag filtering, date filtering, sort dropdown
...
- **Navigation/Pagination:** Auto-generated by Swiper Element (no manual DOM elements needed in render.php)
