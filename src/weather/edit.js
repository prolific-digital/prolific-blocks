...
const getWeatherIcon = (condition) => {
	...
	if (conditionLower.includes('night') && (conditionLower.includes('clear') || conditionLower.includes('fair'))) {
		// Moon icon
		viewBox = '0 0 384 512';
	...
	} else if (conditionLower.includes('snow') || conditionLower.includes('flurries') || conditionLower.includes('blizzard')) {
		// Snowflake icon
		viewBox = '0 0 448 512';
	...
	else if (conditionLower.includes('hot') || conditionLower.includes('heat') || conditionLower.includes('warm')) {
		// Temperature-high icon
		iconPath = 'M416 128c-17.7 0-32-14.3-32-32s14.3-32 32-32s32 14.3 32 32s-14.3 32-32 32zm0 64c53 0 96-43 96-96s-43-96-96-96s-96 43-96 96s43 96 96 96zM96 112c0-26.5 21.5-48 48-48s48 21.5 48 48V276.5c0 17.3 7.1 31.9 15.3 42.5C217.8 332.6 224 349.5 224 368c0 44.2-35.8 80-80 80s-80-35.8-80-80c0-18.5 6.2-35.4 16.7-48.9C88.9 308.4 96 293.8 96 276.5V112zM144 0C82.1 0 32 50.2 32 112V276.5c0 .1-.1 .3-.2 .6c-.2 .6-.8 1.6-1.7 2.8C11.2 304.2 0 334.8 0 368c0 79.5 64.5 144 144 144s144-64.5 144-144c0-33.2-11.3-63.8-30.1-88.1c-.9-1.2-1.5-2.2-1.7-2.8c-.1-.3-.2-.5-.2-.6V112C256 50.2 205.9 0 144 0zm0 416c26.5 0 48-21.5 48-48c0-20.9-13.4-38.7-32-45.3V112c0-8.8-7.2-16-16-16s-16 7.2-16 16V322.7c-18.6 6.6-32 24.4-32 45.3c0 26.5 21.5 48 48 48z';
	} else if (conditionLower.includes('cold') || conditionLower.includes('frigid') || conditionLower.includes('freezing')) {
		// Temperature-low icon
		iconPath = 'M416 64c-17.7 0-32 14.3-32 32s14.3 32 32 32s32-14.3 32-32s-14.3-32-32-32zM352 96c0 53 43 96 96 96s96-43 96-96s-43-96-96-96s-96 43-96 96zM96 112c0-26.5 21.5-48 48-48s48 21.5 48 48V276.5c0 17.3 7.1 31.9 15.3 42.5C217.8 332.6 224 349.5 224 368c0 44.2-35.8 80-80 80s-80-35.8-80-80c0-18.5 6.2-35.4 16.7-48.9C88.9 308.4 96 293.8 96 276.5V112zM144 0C82.1 0 32 50.2 32 112V276.5c0 .1-.1 .3-.2 .6c-.2 .6-.8 1.6-1.7 2.8C11.2 304.2 0 334.8 0 368c0 79.5 64.5 144 144 144s144-64.5 144-144c0-33.2-11.3-63.8-30.1-88.1c-.9-1.2-1.5-2.2-1.7-2.8c-.1-.3-.2-.5-.2-.6V112C256 50.2 205.9 0 144 0zm0 416c26.5 0 48-21.5 48-48c0-20.9-13.4-38.7-32-45.3V112c0-8.8-7.2-16-16-16s-16 7.2-16 16V322.7c-18.6 6.6-32 24.4-32 45.3c0 26.5 21.5 48 48 48z';
	}
	// Visibility
	else if (conditionLower.includes('fog') || conditionLower.includes('mist') || conditionLower.includes('haze') || conditionLower.includes('smoke') || conditionLower.includes('smog')) {
		// Smog icon
		viewBox = '0 0 640 512';
	...
	// Wind
	else if (conditionLower.includes('wind') || conditionLower.includes('breezy') || conditionLower.includes('blustery') || conditionLower.includes('gusty')) {
		// Wind icon
	...
	// Clear/Sunny
	else if (conditionLower.includes('sunny') || conditionLower.includes('clear') || conditionLower.includes('fair')) {
		// Sun icon
