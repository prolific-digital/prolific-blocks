  ...
  try {
    ...
    elements.forEach((el) => {
      ...
      if (el.hasAttributeNS("http://www.w3.org/1999/xlink", "href")) {
        const xlinkHref = el.getAttributeNS(
...
export default function Edit({ attributes, setAttributes, clientId }) {
  ...
  useEffect(() => {
    if (
      !attributes.navigationNextEl ||
      !attributes.navigationPrevEl ||
      !attributes.paginationEl
    ) {
      setAttributes({
  ...
  const fetchSvgContent = async (url) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(
          `SVG fetch failed: ${response.status} ${response.statusText}`
        );
      }
  ...
  return (
    <>
      <InspectorControls>
        ...
        {/* Layout Settings */}
        <PanelBody
          title={__("Layout Settings", "prolific-blocks")}
          initialOpen={false}
        >
          <p className="components-base-control__help">
            {__(
              "Configure how many slides are visible at different screen sizes.",
              "prolific-blocks"
            )}
          </p>
          ...
          <RangeControl
            ...
            step={1}
            help={__(
              "Number of slides visible on mobile screens (0-767px)",
              "prolific-blocks"
            )}
          />
          ...
          <RangeControl
            ...
            step={5}
            help={__(
              "Space in pixels between slides on desktop",
              "prolific-blocks"
            )}
          />
          ...
          <RangeControl
            ...
            step={5}
            help={__(
              "Space in pixels between slides on tablet",
              "prolific-blocks"
            )}
          />
          ...
          <RangeControl
            ...
            step={5}
            help={__(
              "Space in pixels between slides on mobile",
              "prolific-blocks"
            )}
          />
          ...
          <ToggleControl
            ...
            help={__(
              "Center the active slide instead of aligning to the left",
              "prolific-blocks"
            )}
          />
          ...
          <ToggleControl
            ...
            help={__(
              "Carousel height will adapt to the height of the active slide",
              "prolific-blocks"
            )}
          />
          ...
          <ToggleControl
            ...
            help={__(
              "Slides will not have fixed positions, more like a scroll",
              "prolific-blocks"
            )}
          />
        </PanelBody>
            ...
            <>
              ...
              <SelectControl
                ...
                options={[
                  {
                    label: __(
                      "Split (Nav on sides, pagination center)",
                      "prolific-blocks"
                    ),
                    value: "split",
                  },
                  {
                    label: __(
                      "Left (Nav left, pagination right)",
                      "prolific-blocks"
                    ),
                    value: "left",
                  },
                  {
                    label: __(
                      "Right (Pagination left, nav right)",
                      "prolific-blocks"
                    ),
                    value: "right",
                  },
            ...
            <>
              ...
              {pagination && (
                <SelectControl
                  ...
                  onChange={(value) =>
                    setAttributes({ paginationPosition: value })
                  }
                  help={__(
        ...
        <PanelBody
          title={__("Navigation & Controls", "prolific-blocks")}
          initialOpen={false}
        >
          <ToggleControl
            __nextHasNoMarginBottom
            ...
            <>
              <SelectControl
                ...
                options={[
                  ...
                  {
                    label: __("Fraction", "prolific-blocks"),
                    value: "fraction",
                  },
                  {
        ...
        <PanelBody
          title={__("Autoplay Settings", "prolific-blocks")}
          initialOpen={false}
        >
          <ToggleControl
            __nextHasNoMarginBottom
            ...
            help={__(
              "Automatically advance to the next slide (frontend only)",
              "prolific-blocks"
            )}
          />
          ...
          {autoplay && (
            <>
              ...
              <ToggleControl
                ...
                help={__(
                  "Run autoplay in reverse direction",
                  "prolific-blocks"
                )}
              />
              ...
              <ToggleControl
                ...
                help={__(
                  "Display a pause/play button for user control",
                  "prolific-blocks"
                )}
              />
            </>
        ...
        <PanelBody
          title={__("Effects & Transitions", "prolific-blocks")}
          initialOpen={false}
        >
          <SelectControl
            __nextHasNoMarginBottom
          ...
          {effect === "fade" && (
            <Notice status="info" isDismissible={false}>
              {__(
                "Fade effect works best with 1 slide per view",
                "prolific-blocks"
              )}
            </Notice>
          )}
          ...
          {(effect === "cube" || effect === "flip") && (
            <Notice status="info" isDismissible={false}>
              {__(
                "This effect requires exactly 1 slide per view",
                "prolific-blocks"
              )}
            </Notice>
          )}
          ...
          <ToggleControl
            ...
            help={__(
              "Enable continuous loop mode (frontend only)",
              "prolific-blocks"
            )}
          />
        </PanelBody>
        ...
        <PanelBody
          title={__("Interaction Settings", "prolific-blocks")}
          initialOpen={false}
        >
          <ToggleControl
            __nextHasNoMarginBottom
            ...
            help={__(
              "Allow users to swipe/drag slides with touch or mouse",
              "prolific-blocks"
            )}
          />
          ...
          <ToggleControl
            ...
            help={__(
              "Show grab cursor when hovering over carousel",
              "prolific-blocks"
            )}
          />
          ...
          <ToggleControl
            ...
            help={__(
              "Enable navigation with mousewheel scroll",
              "prolific-blocks"
            )}
          />
        ...
        <PanelBody
          title={__("Accessibility", "prolific-blocks")}
          initialOpen={false}
        >
          <ToggleControl
            __nextHasNoMarginBottom
      ...
      >
        ...
        <div className="carousel-new-add-slide-wrapper">
          ...
          <span className="carousel-slide-count-info">
            ...
            {innerBlocks.length === 1
              ? __("slide", "prolific-blocks")
              : __("slides", "prolific-blocks")}
          </span>
        </div>
        ...
        <div className="carousel-new-swiper-wrapper">
            ...
            <swiper-container
              ...
              pagination-el={
                groupControls && pagination
                  ? `.custom-pagination-${uniqueId.current}`
                  : ".swiper-pagination"
              }
          ...
          {!groupControls && navigation && (
            <div
              className={`carousel-new-nav-wrapper nav-position-${
              ...
              <div className="carousel-new-nav-buttons">
                ...
                >
                  {customNavigation && customNavPrevSvg ? (
                    <span
                      dangerouslySetInnerHTML={{ __html: customNavPrevSvg }}
                    />
                  ) : (
                    <span aria-hidden="true">&#10094;</span>
                  )}
                  <span className="screen-reader-text">
                    {__("Previous", "prolific-blocks")}
                  </span>
                </button>
                <button
                ...
                >
                  {customNavigation && customNavNextSvg ? (
                    <span
                      dangerouslySetInnerHTML={{ __html: customNavNextSvg }}
                    />
                  ) : (
                    <span aria-hidden="true">&#10095;</span>
                  )}
                  <span className="screen-reader-text">
                    {__("Next", "prolific-blocks")}
                  </span>
                </button>
              </div>
            </div>
          ...
          {!groupControls && pagination && (
            <div
              className={`swiper-pagination pagination-position-${
          ...
          {groupControls && (navigation || pagination) && (
            <div
              className={`carousel-new-controls-group grouped grouped-position-${
                groupedPosition || "bottom"
              } grouped-layout-${groupedLayout || "split"}`}
            >
              {groupedLayout === "split" ? (
                <>
                  ...
                  {pagination && (
                    <div
                      className={`swiper-pagination custom-pagination-${uniqueId.current} grouped`}
                    ></div>
                  )}
                  {navigation && (
                    <button
        ...
        {autoplay && pauseButton && (
          <button
            className="carousel-new-pause-button"
            aria-label={__("Pause carousel", "prolific-blocks")}
            role="button"
          >
            <span aria-hidden="true">⏸</span>
            <span className="screen-reader-text">
              {__("Pause", "prolific-blocks")}
            </span>
          </button>
        )}
      </div>
