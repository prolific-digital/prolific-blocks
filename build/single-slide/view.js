...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".main-swiper-container").forEach(swiperContainer => {
    const swiperData = JSON.parse(swiperContainer.getAttribute("data-swiper"));
    ...
    if (swiperData.thumbs) {
      ...
      if (thumbsSwiperContainer && thumbsSwiperContainer.classList.contains("thumbs-swiper")) {
        ...
        thumbsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](thumbsSwiperContainer, thumbsSwiperOptions);
      }
    }
    const swiperOptions = {
      // Install modules
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Scrollbar, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Keyboard, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.A11y, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.FreeMode],
